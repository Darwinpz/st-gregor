            ...
            <div id="carouselIndicators" class="carousel slide" data-bs-ride="carousel">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img class="img-fluid" src="<?php echo RUTA_URL;?>/images/instalacion_1.jpg" alt="Imagen 1">
                    </div>
                    <div class="carousel-item">
                        <img class="img-fluid"  src="<?php echo RUTA_URL;?>/images/instalacion_2.jpg" alt="Imagen 2">
                    </div>
                    <div class="carousel-item">
                        <img class="img-fluid"  src="<?php echo RUTA_URL;?>/images/instalacion_3.jpg" alt="Imagen 3">
                    </div>
                    <div class="carousel-item">
                        <img class="img-fluid"  src="<?php echo RUTA_URL;?>/images/instalacion_7.jpeg" alt="Imagen 4">
                    </div>
                </div>
